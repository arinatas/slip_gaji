...
class DosenTetapImport implements ToModel, WithHeadingRow, WithValidation // Gunakan WithHeadingRow
{
    ...
    public function model(array $row)
    {
        return new DosenTetap([
            ...
            'koordinator_matkul' => $row['koordinator_matkul'],
            'x_koordinator_matkul' => $row['x_koordinator_matkul'],
            'nominal_koordinator_matkul' => $row['nominal_koordinator_matkul'],
            'koor_anggota_mbkm' => $row['koor_anggota_mbkm'],
            'x_koor_anggota_mbkm' => $row['x_koor_anggota_mbkm'],
            'nominal_koor_anggota_mbkm' => $row['nominal_koor_anggota_mbkm'],
            'pmb_atau_penguji_mbkm' => $row['pmb_atau_penguji_mbkm'],
            'x_pmb_atau_penguji_mbkm' => $row['x_pmb_atau_penguji_mbkm'],
            'nominal_pmb_atau_penguji_mbkm' => $row['nominal_pmb_atau_penguji_mbkm'],
            ...
            'punishment_ekin' => $row['punishment_ekin'],
            'pph_21' => $row['pph_21'],

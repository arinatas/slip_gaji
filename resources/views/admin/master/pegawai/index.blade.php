	...
	<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
                                    ...
                                    <div class="card-body pb-5">
                                        ...
                                        <div class="card-px pt-10 d-flex justify-content-between">
                                            <!--begin::Title-->
                                                ...
                                                <div class="d-inline">
                                                    <a href="#" class="btn btn-sm btn-primary fs-6" data-bs-toggle="modal" data-bs-target="#kt_modal_new_pegawai">Tambah</a>
                                                </div>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Heading-->
                                            ...
                                            <table class="table table-striped gy-7 gs-7">
                                                <thead>
                                                    <tr class="fw-bold fs-6 text-gray-800 border-bottom-2 border-gray-200">
                                                        ...
                                                        <th class="min-w-100px">Kode Pegawai</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit.pegawai', $item->id ) }}" class="btn btn-sm btn-primary btn-action" data-toggle="tooltip" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                                            <form id="form-delete" action="{{ route('destroy.pegawai', $item->id ) }}" method="POST"
                                ...
                                <!--end::Card-->
                                <!--begin::Modal-->
                                <div class="modal fade" id="kt_modal_new_pegawai" tabindex="-1" aria-hidden="true">
                                    <!--begin::Modal dialog-->
                                            ...
                                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                ...
                                                <form action="{{ route('insert.pegawai') }}" method="POST">
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <input class="form-control form-control-solid" type="text" name="kode_pegawai" required value=""/>
                                                    </div>
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="d-flex align-items-center fs-6 fw-bold form-label mb-2">
                                                    ...
                                                    <div class="d-flex flex-column mb-7 fv-row">
                                                        ...
                                                        <select class="form-select form-select-solid" name="jenis" required>
                                                            ...
                                                            <option value="4">Unit Usaha</option>
                                                        </select>
                                                    </div>
                                                    <!--end::Input group-->
                                                    <!--begin::Actions-->

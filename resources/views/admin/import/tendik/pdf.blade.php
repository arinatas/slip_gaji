        ...
        <div class="slip-gaji">
                ...
                <div class="row">
                    ...
                    <div class="col-12 table-responsive" style="text-align: center; padding: 10px;">
                        <h4 style="margin: 5px 0;">SLIP GAJI KARYAWAN</h4>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->tunjangan_jabatan )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->tunjangan_lembur )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->tunj_pel_mhs_op_feeder )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->tunjangan_kinerja )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->bonus )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;"><b> + Rp. @currency( $item->jumlah_penambah )</b></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->potongan_kasbon )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->denda_keterlambatan )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                    ...
                                    <td style="text-align: right;">Rp. @currency( $item->potongan_pph_21 )</td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: right;"><b> - Rp. @currency( $item->jumlah_pengurang )</b></td>
                                </tr>
                                <tr>
                                    <td>
                                        <div>

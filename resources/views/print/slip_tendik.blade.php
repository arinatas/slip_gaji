...
<html>
    <head>
        ...
        <title>Keuangan Primakara</title>
            ...
            <section class="invoice">
                ...
                <div class="row invoice-info">
                    <div class="col-sm-9 invoice-col mt-3">
                        <address>
                            <strong>Universitas Primakara</strong><br>
                            Jl. Tukad Badung No.135<br>  Renon, Denpasar Selatan, Kota Denpasar, Bali 80226<br>
                            Telp/Fax : 03618956085
                        </address>
                    </div>
                    <!-- /.col -->
                </div>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: end;"><b> Rp. @currency($Datas[0]->gaji_yang_dibayar)</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12 invoice-col mt-5">
                        <address style="float: inline-end;" class="mr-5">
                            <strong>Denpasar, 31 Desember 2023</strong><br>
